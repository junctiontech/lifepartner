...
if(!$CONNECTION)
{
	...
	exit();
		...
		$incomes = str_replace(',', '',$income);//echo $income;die;
		$salary = $Totaldata['profileData'][0]['income'];
		$salarys = str_replace(',', '', $salary);
